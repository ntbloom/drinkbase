...
class TestNameSearch(unittest.TestCase):
    ...
    def test_single_name1(self):
        self.assertEqual(api("names/?name=bitter french"), ["Bitter French"])
    ...
    def test_single_incl3(self):
        self.assertEqual(
            api("ingreds/?incl=heering"), ["Blood & Sand", "Singapore Sling"]
        )
    ...
    def test_multiple_incl5(self):
        self.assertEqual(api("ingreds/?incl=bourbon, grapefruit"), ["Brown Derby"])

    def test_more_multiple_incl6(self):
        self.assertEqual(api("ingreds/?incl=apple, mint"), ["Jersey Julep"])

    # excluded tests
    def test_multiple_excl8(self):
        self.assertEqual(api("ingreds/?excl=juice, bitters"), noJuiceBitters)
    ...
    def test_multiple_incl_single_excl10(self):
        self.assertEqual(
            api("ingreds/?incl=rye, vermouth&excl=bitters"), ["Boulevardier", "Old Pal"]
        )
    ...
    def test_edge_case_incl_blank_excl(self):
        self.assertEqual(
            api("ingreds/?incl=heering&excl="), ["Blood & Sand", "Singapore Sling"]
        )
